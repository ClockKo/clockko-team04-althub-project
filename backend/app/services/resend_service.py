...
class ResendEmailService:
    def __init__(self):
        ...
        self.from_email = os.getenv("RESEND_FROM_EMAIL", "noreply@clockko.com")
        self.from_name = os.getenv("RESEND_FROM_NAME", "ClockKo Team")
    ...
    def send_email(self, to_email: str, subject: str, html_content: str, text_content: Optional[str] = None) -> bool:
        ...
        if not self.is_available():
            logger.error("Resend not available - email not sent")
            return False
        ...
        try:
            ...
            if response:
                ...
                logger.error(f"❌ Resend API error: No response")
                return False
    ...
    def send_welcome_email(self, to_email: str, user_name: str, otp_code: str = "") -> bool:
        ...
        if otp_code:
            ...
            <div style="background-color: #f9f9f9; padding: 20px; border-radius: 8px; margin: 20px 0;">
                ...
                <div style="font-size: 32px; font-weight: bold; text-align: center; background-color: #f0f8ff; padding: 20px; border-radius: 8px; margin: 20px 0; letter-spacing: 5px; color: #2563eb;">{otp_code}</div>
                <p>This code will expire in {settings.OTP_EXPIRE_MINUTES} minutes.</p>
            </div>
            """
